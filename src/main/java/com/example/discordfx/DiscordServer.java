...
public class DiscordServer implements Initializable {
    ...
    public ImageView changeNameIcon;
    public ImageView channelsIcon;
    public Button deleteServer;
    public ImageView makeChannelIcon;
    public ImageView makeRoleIcon;
    public Button resumeButton;
    public ImageView resumeIcon;
    public Button stopButton;
    public ImageView stopIcon;
    public ImageView membersIcon;
